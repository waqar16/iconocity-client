...
const GeneratePageComponent = () => {
  ...
  const [isShowingSimilarIcons, setIsShowingSimilarIcons] =
  ...
  const steps: Step[] = [
    {
      ...
      content: "1. Get Start by uploading an image file",
    },
    {
      target: ".url-generator",
      content:
        "2. Or Provide a URL of an image or even a Figma file here to generate icons.",
    },
    {
      target: ".color-selector",
      content:
        "3. This section allows you to select and customize colors for your design. Use it to choose the perfect color palette.",
    },
    {
      target: ".shape-selector",
      content:
        "4. Here you can find and choose different shapes for your icons. Browse and select to customize your icons effectively.",
    },
    {
      target: ".generate-button",
      content:
        "5. Once u finished with styles, Colors and image u can click on generate button to generate your icons",
    },
    {
      target: ".svg-generator",
      content:
        "6. Once icons are generated. You will see your extracted icons here ",
    },
    {
      target: ".project-list",
      content:
        "7. Here you can find a list of all your active projects. Click on a project to view or edit it.",
    },
    {
      target: ".project-history",
      content:
        "8. This section shows your project history. Review and revisit your past work here.",
    },

    {
      target: ".chat-with-ai",
      content:
        "9. Engage with our AI assistant here. Get answers to your questions and generate icons with our powerful AI model.",
    },
  ];
  ...
  return (
    <ProjectProvider>
      <div className="relative flex gap-5 h-full max-h-[100vh] ">
        ...
        {/* center */}
        <div
          className="h-[calc(100vh-74px)] flex-1 overflow-y-auto hide-scrollbar pb-10"
          ref={containerRef}
        >
