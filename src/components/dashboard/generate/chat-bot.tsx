...
const ChatBot:React.FC<ChatBotProps> = ({keywords,setPageNumber,setShowChat}) => {
  // context
  ...
  return (
    <div className="absolute bottom-[-50px] right-[-50px] bg-chatbot-gradient border border-white rounded-2xl px-8 py-5 mt-5 w-[400px] z-[100]">
            {/* input field */}
