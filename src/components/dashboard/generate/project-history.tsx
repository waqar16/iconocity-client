    ...
    >
      ...
      <DialogActions>
        ...
        <button
          ...
          onClick={() => {
            handleConfirm(history?.history_id);
          }}
        >
          Delete
        </button>
...
const ProjectHistory = () => {
  ...
  const [showMoreHistory, setShowMoreHistory] = useState(false);
  const [deletingHistoryName, setDeletingHistoryName] = useState<{
    history_id: number;
    name: string;
  } | null>(null);
  const historyRef = useRef<HTMLDivElement | null>(null);
  ...
  return (
    <div className=" pb-7 px-6 mt-5 2xl:mt-10">
      <div className="w-full flex flex-row items-center justify-between">
        ...
        <Tooltip
          title="View your working history here. You can edit the history name by clicking its label."
          placement="top"
          sx={{
            tooltip: {
      ...
      {isLoading ? (
        ...
        <div
          ref={historyRef}
          className=" transition-all duration-500 ease-in-out mt-4 "
          style={{ height: "250px" }}
        >
          {localData &&
            localData
              ...
              .map(({ history_id, history_date, name }) => (
                ...
                >
                  <div className="flex flex-row items-center justify-between w-full">
                    ...
                    {editLoading.id == history_id ? (
                      <p className="text-[11px]">Updating...</p>
                    ) : (
